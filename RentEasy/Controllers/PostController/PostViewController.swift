...
class PostViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, PhotoGalaryCollectionViewCellDelegate, PostViewDelegate {
    ...
    private func handleUploadSucess() {
        // Clear form fields
        ...
        // Reset or clear the collection view
        self.postView.photoCollectionView.dataSource = nil
    ...
    @objc private func keyboardWillShow(_ notification: Notification) {
        ...
        postView.addCreateButton.snp.updateConstraints { make in
